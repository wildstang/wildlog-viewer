...
public abstract class LogRenderer
{
   ...
   {
      // If the timestamp of the first element in the array is greater than the
      // target, return 0
   ...
   {
      // If the timestamp of the last element in the array is less than the
      // target, return the last index
   ...
   public static int findIndexOfClosestPointToTimestamp(
         List<DataPoint> dataPoints, long targetTimestamp)
   {
   ...
   public static long mapPointInRangeToTimestamp(long startTimestamp,
         long endTimestamp, long startRange, long endRange, long positionInRange)
   {
      return (long) (startTimestamp + ((double) (positionInRange - startRange)
            / (double) (endRange - startRange) * (endTimestamp - startTimestamp)));
   }
